...
KeenKeeper is a simple friendship tracker app. In this app users can see their friends, check friend details, add quick check-in activity and see timeline and stats.
